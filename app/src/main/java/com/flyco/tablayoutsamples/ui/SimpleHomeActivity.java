...
public class SimpleHomeActivity extends AppCompatActivity {
    ...
    private final String[] mItems = {"SlidingTabLayout", "CommonTabLayout", "SegmentTabLayout", "CustomSildingTabLayout"};
    private final Class<?>[] mClasses = {SlidingTabActivity.class, CommonTabActivity.class,
            SegmentTabActivity.class, CustomSlidingTabActivity.class};
